...
export type DockVerticalPosition = "top" | "bottom" 
export type DockHorizontalPosition = "left" | "right" 

export type ControlPosition = {x: number, y: number, docks: { vertical: DockVerticalPosition, horizontal: DockHorizontalPosition } };
