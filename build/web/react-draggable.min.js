...
/******/ 	return __webpack_require__(__webpack_require__.s = "./lib/cjs.js");
/******/ })
/************************************************************************/
/******/ ({
...
function (_React$Component) {
  ...
  function DraggableCore() {
    ...
    DraggableCore_defineProperty(_assertThisInitialized(_this), "handleDragStart", function (e) {
      ...
      if (_this.props.disabled || _this.props.handle && !matchesSelectorAndParentsTo(e.target, _this.props.handle, thisNode) || _this.props.cancel && matchesSelectorAndParentsTo(e.target, _this.props.cancel, thisNode)) {
        return;
...
/* concated harmony reexport DraggableCore */__webpack_require__.d(__webpack_exports__, "DraggableCore", function() { return DraggableCore_DraggableCore; });
function Draggable_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Draggable_typeof = function _typeof(obj) { return typeof obj; }; } else { Draggable_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Draggable_typeof(obj); }
...
function Draggable_slicedToArray(arr, i) { return Draggable_arrayWithHoles(arr) || Draggable_iterableToArrayLimit(arr, i) || Draggable_nonIterableRest(); }

function Draggable_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance"); }

function Draggable_iterableToArrayLimit(arr, i) { if (!(Symbol.iterator in Object(arr) || Object.prototype.toString.call(arr) === "[object Arguments]")) { return; } var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
function (_React$Component) {
  ...
  /*: DraggableProps*/
    ...
    _this = Draggable_possibleConstructorReturn(this, Draggable_getPrototypeOf(Draggable).call(this, props));
    ...
    Draggable_defineProperty(Draggable_assertThisInitialized(_this), "onDragStop", function (e, coreData) {
      ...
      var shouldStop = _this.props.onStop(e, createDraggableData(Draggable_assertThisInitialized(_this), coreData));
  ...
  Draggable_createClass(Draggable, [{
    ...
    /*: ReactElement<any>*/
    {
      ...
      return external_commonjs_react_commonjs2_react_amd_react_root_React_default.a.createElement(DraggableCore_DraggableCore, _extends({}, draggableCoreProps, {
